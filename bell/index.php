...
<head>
    ...
    <title>Bell — Comfort Food & Bowls | Homestyle Goodness in Every Bite</title>
    <meta name="description" content="Hearty comfort food, bowls, and home-style dishes.">
...
<div class="splash" id="splash">
    <div class="splash-ring">
        <img src="assets/logo.png" alt="Bell" class="splash-logo" onerror="this.style.display='none'">
        <div class="splash-text">BELL</div>
        <div class="splash-tagline">Homestyle Goodness in Every Bite</div>
    </div>
</div>
...
<header class="site-header" id="siteHeader">
    <div class="header-inner">
        <a href="/bell/" class="logo">
            <img src="assets/logo.png" alt="Bell" class="logo-img" onerror="this.style.display='none';this.nextElementSibling.style.display='flex'">
            <span class="logo-icon" style="display:none">🍲</span>
            <span class="logo-text">Bell</span>
        </a>
...
<section class="hero">
    ...
    <div class="hero-content">
        <div class="hero-badge">
            ...
            <span>🍲 Home-Style & Fresh</span>
        </div>
        <h1>
            <span class="hero-line">Comfort Food</span>
            <span class="hero-line highlight">You'll Love</span>
        </h1>
        <p class="hero-desc">Hearty bowls, soul-warming soups, and homestyle mains — comfort food made with love and fresh ingredients.</p>
        <div class="hero-cta">
...
<footer class="site-footer">
    <div class="footer-inner">
        <div class="footer-brand">
            <img src="assets/logo.png" alt="Bell" class="footer-logo" onerror="this.style.display='none'">
            <div>
                <div class="footer-name">Bell</div>
                <div class="footer-tag">Homestyle Goodness in Every Bite</div>
            </div>
        </div>
        ...
        <p class="footer-copy">&copy; 2026 Bell — Bell — Comfort Food & Bowls. All rights reserved.</p>
    </div>
</footer>
...
<div class="confirm-modal" id="order-confirm">
    <div class="confirm-box">
        ...
        <h2>Your Cart Diterima! 🎉</h2>
        <p>Your Cart <strong id="confirm-order-num"></strong> telah diterima. Kami akan segera menyiapkannya!</p>
...
<div class="chat-widget" id="chatWidget">
    <div class="chat-widget-header">
        <div class="chat-widget-avatar">
            <img src="assets/logo.png" alt="Bell" onerror="this.style.display='none';this.parentElement.innerHTML='🍲'">
        </div>
        <div class="chat-widget-info">
            <div class="chat-widget-name">Bell Support</div>
    ...
    <div class="chat-widget-messages" id="chatMessages">
        <div class="chat-widget-msg theirs">
            <div class="chat-widget-bubble">Halo! 👋 Selamat datang di Bell. Ada yang bisa kami bantu?</div>
