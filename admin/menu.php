...
<div style="display:flex;align-items:center;gap:1rem;margin-bottom:1.25rem">
    <div style="font-size:.95rem;color:#64748b">
        <strong style="color:#059669"><?= htmlspecialchars($restaurant['name'] ?? 'Restaurant') ?></strong> &bull;
...
document.getElementById('item-image-file')?.addEventListener('change', async function(e) {
    ...
    try {
        ...
        } else { alert(d.error || 'Upload failed'); saveBtn.textContent = 'Save Item'; saveBtn.disabled = false; }
    } catch (err) { alert('Upload failed'); saveBtn.textContent = 'Save Item'; saveBtn.disabled = false; }
});
