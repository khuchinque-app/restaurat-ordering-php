...
// Fetch customer chat conversations (latest message per conversation)
...
<div class="chat-main">
    ...
    <div class="chat-main-header">
        ...
        <span style="font-size:.78rem;color:#94a3b8;margin-left:.5rem">All staff members</span>
    </div>
    <!-- Presence Bar -->
    ...
    <div class="chat-main-header">
        ...
        <span style="font-size:.78rem;color:#94a3b8;margin-left:.5rem">Select a conversation</span>
    </div>
...
function showCustomerChat(chatId, name, orderNum) {
    ...
    document.querySelector('.chat-main-header strong').textContent = '👤 ' + name;
    document.querySelector('.chat-main-header span').textContent = orderNum ? 'Order #'+orderNum : '';
