...
<head>
    ...
    <title>Aseng — Authentic Asian Flavors | Authentic Asian Flavors</title>
    <meta name="description" content="Authentic Palembang Authentic Asian Flavors. Handcrafted, fresh daily. Order now for delivery.">
...
<div class="splash" id="splash">
    <div class="splash-ring">
        <img src="assets/logo.png" alt="Aseng" class="splash-logo" onerror="this.style.display='none'">
        <div class="splash-text">ASENG</div>
        <div class="splash-tagline">Authentic Asian Flavors</div>
    </div>
</div>
...
<header class="site-header" id="siteHeader">
    <div class="header-inner">
        <a href="/aseng/" class="logo">
            <img src="assets/logo.png" alt="Aseng" class="logo-img" onerror="this.style.display='none';this.nextElementSibling.style.display='flex'">
            <span class="logo-icon" style="display:none">🍲</span>
            <span class="logo-text">Aseng</span>
        </a>
...
<section class="hero">
    ...
    <div class="hero-content">
        ...
        <p class="hero-desc">Experience the taste of tradition with every bite. Made with the finest ingredients, served with love.</p>
        <div class="hero-cta">
...
<footer class="site-footer">
    <div class="footer-inner">
        <div class="footer-brand">
            <img src="assets/logo.png" alt="Aseng" class="footer-logo" onerror="this.style.display='none'">
            <div>
                <div class="footer-name">Aseng</div>
                <div class="footer-tag">Authentic Asian Flavors</div>
            </div>
        </div>
        ...
        <p class="footer-copy">&copy; 2026 Aseng — Authentic Asian Flavors. All rights reserved.</p>
    </div>
</footer>
...
<div class="chat-widget" id="chatWidget">
    <div class="chat-widget-header">
        <div class="chat-widget-avatar">
            <img src="assets/logo.png" alt="Aseng" onerror="this.style.display='none';this.parentElement.innerHTML='🍲'">
        </div>
        <div class="chat-widget-info">
            <div class="chat-widget-name">Aseng Support</div>
    ...
    <div class="chat-widget-messages" id="chatMessages">
        <div class="chat-widget-msg theirs">
            <div class="chat-widget-bubble">Hi there! 👋 Welcome to Aseng. How can we help?</div>
...
<nav class="bottom-nav" id="bottomNav">
    <a href="/aseng/" class="bottom-nav-item active">
