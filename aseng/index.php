...
<head>
    ...
    <title>Aseng — Authentic Asian Flavors</title>
...
<section class="hero">
    <div class="hero-content">
        <div class="hero-badge">&#127860; Fresh &amp; Authentic</div>
        <h1>Authentic Flavors,<br>Freshly Prepared</h1>
        <p>Experience the taste of tradition with every bite. Made with the finest ingredients, served with love.</p>
...
<footer class="site-footer">
    <p>&copy; 2026 Aseng &mdash; Authentic Asian Flavors</p>
</footer>
...
<div class="confirm-modal" id="order-confirm">
    <div class="confirm-box">
        ...
        <div style="display:flex;flex-direction:column;gap:.5rem;margin-top:.6rem">
            <a href="https://t.me/pempekaseng" target="_blank" style="display:block;padding:.55rem 1rem;background:#0088cc;color:#fff;border-radius:8px;text-decoration:none;font-weight:700;font-size:.9rem;text-align:center" onclick="window.open('https://t.me/pempekaseng')">
                📱 Chat via Telegram
            </a>
        ...
        <button class="confirm-btn" onclick="document.getElementById('order-confirm').classList.remove('open')">Kembali</button>
    </div>
</div>
