...
<head>
    ...
    <title>P2P — Street Food & Snacks | Quick, Tasty, Affordable</title>
    <meta name="description" content="Street food favorites. Bold flavors, quick bites.">
...
<div class="splash" id="splash">
    <div class="splash-ring">
        <img src="assets/logo.png" alt="P2P" class="splash-logo" onerror="this.style.display='none'">
        <div class="splash-text">P2P</div>
        <div class="splash-tagline">Quick, Tasty, Affordable</div>
    </div>
</div>
...
<header class="site-header" id="siteHeader">
    <div class="header-inner">
        <a href="/p2p/" class="logo">
            <img src="assets/logo.png" alt="P2P" class="logo-img" onerror="this.style.display='none';this.nextElementSibling.style.display='flex'">
            <span class="logo-icon" style="display:none">🍲</span>
            <span class="logo-text">P2P</span>
        </a>
...
<section class="hero">
    ...
    <div class="hero-content">
        <div class="hero-badge">
            ...
            <span>🍣 Fresh & Affordable</span>
        </div>
        <h1>
            <span class="hero-line">Street Food</span>
            <span class="hero-line highlight">Done Right</span>
        </h1>
        <p class="hero-desc">Authentic street eats, quick bites, and satisfying snacks — all made fresh and delivered fast.</p>
        <div class="hero-cta">
...
<footer class="site-footer">
    <div class="footer-inner">
        <div class="footer-brand">
            <img src="assets/logo.png" alt="P2P" class="footer-logo" onerror="this.style.display='none'">
            <div>
                <div class="footer-name">P2P</div>
                <div class="footer-tag">Quick, Tasty, Affordable</div>
            </div>
        </div>
        ...
        <p class="footer-copy">&copy; 2026 P2P — P2P — Street Food & Snacks. All rights reserved.</p>
    </div>
</footer>
...
<div class="chat-widget" id="chatWidget">
    <div class="chat-widget-header">
        <div class="chat-widget-avatar">
            <img src="assets/logo.png" alt="P2P" onerror="this.style.display='none';this.parentElement.innerHTML='🍲'">
        </div>
        <div class="chat-widget-info">
            <div class="chat-widget-name">P2P Support</div>
    ...
    <div class="chat-widget-messages" id="chatMessages">
        <div class="chat-widget-msg theirs">
            <div class="chat-widget-bubble">Halo! 👋 Selamat datang di P2P. Ada yang bisa kami bantu?</div>
